...
var SAIB = function (_Bank) {
  (0, _inherits3.default)(SAIB, _Bank);

  function SAIB() {
    (0, _classCallCheck3.default)(this, SAIB);

    var url = 'http://www.saib.com.eg/foreign-currencies/';
    return (0, _possibleConstructorReturn3.default)(this, (SAIB.__proto__ || (0, _getPrototypeOf2.default)(SAIB)).call(this, _banks_names.banksNames.SAIB, url));
  }
  ...
  (0, _createClass3.default)(SAIB, [{
    key: 'scraper',
    value: function scraper(html) {
      var $ = _cheerio2.default.load(html);
      var tableRows = $('.cont table tbody tr');
      var rates = [];
